...
boost::python::tuple PyBaseObjectRecIter::next()
{
    ...
    {
        std::auto_ptr<AxObject> obj(
                               dynamic_cast<AxObject*>( nextPtr.release() ) );
        
        IAAFObjectSP sp = *obj.get();
        AxString text = L"";
        ...
        std::auto_ptr<AxProperty> prop( 
                 dynamic_cast<AxProperty*>( nextPtr.release() ) );
        AxString text = L"";
        IAAFPropertySP sp = *prop.get();
    ...
    else if (dynamic_cast<AxPropertyValue*>(nextPtr.get() ))
    {
        ...
        std::auto_ptr<AxPropertyValue> propVal(
                                          dynamic_cast<AxPropertyValue*>( nextPtr.release() ) );
        
        AxString text = L"";
        IAAFPropertyValueSP obj = *propVal.get();
